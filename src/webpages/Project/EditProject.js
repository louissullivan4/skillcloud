...
const EditProfile = () => {
    ...
    const sendData = async () => {
        const resp = await fetch(`http://scbackend-env.eba-93hey2mi.eu-north-1.elasticbeanstalk.com/`,{'method':'POST', headers : {'Content-Type':'application/json'}, body: JSON.stringify(finalInfo)})
